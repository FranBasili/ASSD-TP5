...
n=1:(N-1)/2;
h(n)=((sin(2*pi*fc2*n)-sin(2*pi*fc1*n))./(pi*n));         % h(n) for BandPass
...
F0dB=(fc1+(fc2-fc1)/2)*fs             % F0dB es la frecuencia donde la ganancia del filtro debe ser unitaria ( 0 dB) esto es la banda pasante del filtro
